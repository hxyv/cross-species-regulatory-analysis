...
## Human-coordinate handoff for motif analysis

The human-specific mapped set above is in mouse coordinates because HALPER mapped human peaks to mouse. For human enhancer/promoter motif analysis, use the recovered original human-coordinate files instead:
...
Recovery counts are recorded in:
